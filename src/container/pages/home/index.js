...
class Home extends Component {
  ...
  componentDidMount() {
    ...
    new mapboxgl.Marker().setLngLat([107.041169, -6.278591]).addTo(map);
  }
            ...
            <div className="menu-nav">
              <ul className="menu-list">
                <li className="menu-item">
                  <a href="#Beranda" className="menu-link">
                    Beranda
                  </a>
                </li>
                <li className="menu-item">
                ...
                <li className="menu-item">
                <a href="https://s.id/1kGF4" className="button">
               <Button title="Daftar PPDB" />
               </a>
                </li>
              </ul>
            </div>
        ...
        <div className="container">
          <section id="header">
            <div className="title-main-header">
              ...
              <a href="https://www.smkbinaprestasi.sch.id/web/" className="button">
          ...
          <section id="cta-website">
            <div className="left-side">
              <h4 className="text-attention">
                Untuk melihat galeri SMK BINA PRESTASI lebih lengkap, silahkan klik tombol Galeri!
              </h4>
            </div>
            <div className="right-side">
            <a href="https://www.smkbinaprestasi.sch.id/web/galerismkbinaprestasi/" className="button">
              <Button title="Galeri" />
              </a>
            </div>
          </section>
          ...
          <section>
            <div className="title-header">
              ...
              <a href="https://g.page/smkbinaprestasi?share"><h4>Ini adalah lokasi sekolah kami.</h4></a>
              </span>
            </div>
          ...
          <section className="contact" id="contact">
            <div className="contact-us">
              ...
              <p className="nomer-text">WA : 081310849726 </p>
